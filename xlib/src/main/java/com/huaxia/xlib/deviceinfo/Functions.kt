package com.huaxia.xlib.deviceinfo
                ...
                if (!add.isLoopbackAddress) {
                    ...
                    if (useIPv4) {
                        ...
                        if (!isIPv4) {
                            ...
                            return if (index < 0) hostAddress.uppercase(Locale.ROOT) else hostAddress.substring(
                                                            0,
                                                            index
        ...
        get() {
            ...
            return (
                    Build.FINGERPRINT.startsWith("generic") ||
                            ...
                            (appCtx.getSystemService(Context.TELEPHONY_SERVICE) as TelephonyManager).networkOperatorName.lowercase(
                                Locale.ROOT
                            ) == "android" ||
                            !canResolveIntent
                    )
