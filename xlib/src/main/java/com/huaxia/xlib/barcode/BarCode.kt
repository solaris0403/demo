...
package com.huaxia.xlib.barcode
...
import com.huaxia.xlib.Encoding
import com.huaxia.xlib.resource.appColor
...
fun createQRCode(
    ...
    margin: Int = 4,
    @ColorInt colorBlack: Int = appColor(R.color.black),
    @ColorInt colorWhite: Int = appColor(R.color.white)
): Bitmap {
    val hints = mapOf(
